...
Full details: [/products/vantahire](/products/vantahire)
  ...
  {
    slug: "orion-metal-industries-b2b-fabrication-website",
    title: "Case Study: Orion Metal Industries — B2B Fabrication Website",
    excerpt:
      "Custom Next.js website for a Moorabbin sheet metal fabricator: SEO for Melbourne and Victoria, quote enquiries with drawing uploads, and Supabase-backed products and blog.",
    category: "Web Development",
    date: "2026-09-12",
    readTime: "8 min",
    color: "#dc2626",
    keywords:
      "Orion Metal Industries, sheet metal fabrication Melbourne, laser cutting Moorabbin, B2B manufacturing website, Next.js Australia, Supabase blog, fabrication quote form, NexCraft portfolio",
    content: `
## Precision. Strength. Quality.

**Orion Metal Industries Pty Ltd** is a precision sheet metal fabrication business in Moorabbin, Victoria — serving commercial and industrial clients across Melbourne with laser cutting, bending, fabrication, powder coating, and custom assembly.

NexCraft designed and built their production marketing and lead-generation site: [orionmetalindustries.com.au](https://orionmetalindustries.com.au/) · [Portfolio detail →](/portfolio/orion-metal-industries)

**Tagline on site:** *Precision. Strength. Quality.*

---

## What the client needed

| Challenge | How the site addresses it |
|-----------|---------------------------|
| **Lead generation** | Quote requests and WhatsApp from major pages; contact form emails enquiries **with attachments** to business inboxes |
| **Trust for buyers** | Clear services, material capabilities (e.g. mild steel to 20mm), project gallery, and company details |
| **SEO & content** | Blog and service pages targeting fabrication, laser cutting, and powder coating in Moorabbin / Melbourne |
| **Scalable content** | Products, posts, customers, and reviews structured in **Supabase** for updates without redeploying code |
| **Professional brand** | Custom **.com.au** domain, sitemap, and local business schema |
| **Always-on help** | Chatbot answers services, materials, and how to get a quote |

---

## Stack & deliverables

**Tech:** Next.js 15 · React 19 · Tailwind CSS · Supabase · Nodemailer · SEO (metadata, sitemap, structured data) · Vercel

**Main pages:** Home, About, Services (laser cutting materials/thicknesses), Products, Projects gallery, Industries, Blog, Contact, Privacy, Terms

**Notable features:**

- Contact form uploads: **PDF, DWG, DXF, STEP, images, ZIP**
- Real workshop and product photography across services, products, and blog
- Local SEO for **Moorabbin, Melbourne, Victoria**
- Mobile-responsive UI including tablet navigation
- Premium industrial UI — dark theme, red/white/black brand
- Optional 3D hero visual
...
| Item | Detail |
|------|--------|
| **Client** | Orion Metal Industries Pty Ltd |
| **Industry** | Sheet metal fabrication (commercial & industrial) |
| **Region** | 1A Bibby Ct, Moorabbin VIC 3189, Australia |
| **Live site** | [orionmetalindustries.com.au](https://orionmetalindustries.com.au/) |
| **Role** | Design, development, deployment, content integration |
| **Outcome** | Professional online presence for commercial leads and future content growth |

---

## One-line summary

Custom Next.js website for a Moorabbin sheet metal fabricator, focused on **SEO**, **quote enquiries**, and **scalable product/blog content**.

---

## Need a similar site?

Whether you are in manufacturing, trades, or B2B services in Australia or India, we build sites that rank, capture enquiries, and scale with your content.

[Talk to NexCraft →](/#contact) · [More portfolio work →](/#portfolio)
    `,
  },
  {
