const portfolioData = {
  ...
  "orion-metal-industries": {
    ...
    tagline: "Precision sheet metal fabrication — SEO, quote enquiries, and scalable content.",
    url: "https://orionmetalindustries.com.au/",
    image: "/project/orionmetalindustries.png",
    color: "#dc2626",
    tags: ["Next.js", "React", "Tailwind", "Supabase", "SEO", "B2B", "Manufacturing", "Vercel"],
    category: "Business Website",
    duration: "6 weeks",
    year: "2026",
    challenge:
      "Orion Metal Industries Pty Ltd needed more than a brochure site. As a Moorabbin-based commercial fabricator serving Melbourne and Victoria, they had to rank for laser cutting and fabrication searches, win trust from procurement buyers, and capture quote requests with engineering drawings — without rebuilding the site every time products or blog content changed.",
    solution:
      "We designed and built a full commercial Next.js 15 site with a premium industrial UI (dark theme, red/white/black brand), service pages with documented materials and thicknesses, a Supabase-backed product catalogue and blog, project gallery, and industries content. A secure contact form accepts PDF, DWG, DXF, STEP, images, and ZIP uploads and routes enquiries via Nodemailer to business inboxes. Local SEO, sitemap, structured data, WhatsApp CTAs, and an on-site chatbot support leads around the clock. Deployed on Vercel at orionmetalindustries.com.au.",
    results: [
      { label: "Quote flow", value: "Multi-file", desc: "Drawings & specs attached to every enquiry" },
      { label: "Content", value: "Supabase", desc: "Products, blog, reviews, customers without redeploys" },
      { label: "Local SEO", value: "Melbourne", desc: "Moorabbin, Victoria, and service-intent pages" },
      { label: "Live domain", value: ".com.au", desc: "Production hosting on Vercel" },
    ],
    features: [
      "Contact form with PDF, DWG, DXF, STEP, image, and ZIP uploads",
      "Supabase catalogue, blog, reviews, and customer data",
      "Services with laser cutting materials and thicknesses",
      "Projects gallery and industries pages",
      "Metadata, sitemap, and local business structured data",
      "WhatsApp CTAs and on-site chatbot for common questions",
      "Mobile-responsive layout with workshop photography",
      "Optional 3D hero visual and premium industrial UI",
    ],
  },
};
